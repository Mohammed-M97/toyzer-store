            ...
            <div>
              ...
              <div className='mt-1 relative rounded-md shadow-sm'>
                ...
                <input
                  ...
                  className='block w-full px-3 py-2 pl-10 bg-gray-700 text-white border border-gray-600 
                                    rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-gray-500 
            ...
            <div>
              ...
              <div className='mt-1 relative rounded-md shadow-sm'>
                ...
                <input
                  ...
                  className='block text-white w-full px-3 py-2 pl-10 bg-gray-700 border border-gray-600 
                                    rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-gray-500 
                                    focus:border-gray-500 sm:text-sm'
                  placeholder='••••••••'
                />
